...
if st.button("Dapatkan Rekomendasi Menu"):
    ...
    prompt = f"Saya sedang merasa {mood_pilihan}. {tanya_tambahan}. Berikan 2 rekomendasi makanan atau minuman beserta fotonya juga yang sehat secara ilmiah untuk mood ini, sertakan resep singkat dan fun fact nutrisinya."
